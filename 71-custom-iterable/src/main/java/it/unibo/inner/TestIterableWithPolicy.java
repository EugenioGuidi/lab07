...
public class TestIterableWithPolicy {
    ...
    private static <T> IterableWithPolicy<T> getIterableWithPolicy(T[] elements, Predicate<T> filter) {
        IterableWithPolicyImpl<T> iterableWithPolicy = new IterableWithPolicyImpl<>(elements, filter);
        return iterableWithPolicy; // TODO: return the implementation of IterableWithPolicy
    }

    private static <T> IterableWithPolicy<T> getIterableWithPolicy(T[] elements) {
        IterableWithPolicyImpl<T> iterableWithPolicy = new IterableWithPolicyImpl<>(elements);
        return iterableWithPolicy;
    }
